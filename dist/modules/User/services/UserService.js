...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.save = function (_a) {
    ...
    UserService.prototype.auth = function (_a) {
        var email = _a.email, senha = _a.senha;
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, user, _b, secret, expiresIn, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        token = jsonwebtoken_1.sign({ admin: user.flag_adm }, secret, {
                            subject: user.id,
                            expiresIn: expiresIn,
                        });
