...
var UserService_1 = __importDefault(require("@modules/User/services/UserService"));
var userRouter = express_1.Router();
userRouter.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nome, email, senha, userService, user, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, userService.save({ nome: nome, email: email, senha: senha })];
            case 1:
                user = _b.sent();
